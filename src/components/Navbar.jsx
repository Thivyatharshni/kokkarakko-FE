      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => scrollToSection('top', 'landing')}>
          ...
          <div className="leading-tight">
            <span className="block text-xl font-black text-[#111111] tracking-tight uppercase">{brandMain}</span>
            <span className="block text-[9px] font-bold text-gray-500 uppercase tracking-widest">{brandSub || 'Fried Chicken'}</span>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center gap-8 font-black text-sm uppercase tracking-wider">
          <button 
            ...
            className={`nav-link relative py-2 text-[#111111] hover:text-[#E50914] transition-colors ${activeTab === 'landing' ? 'active' : ''}`}
          >
            Landing Page
          </button>
        ...
        <div>
          <button 
            ...
            className="premium-btn flex items-center gap-2 bg-[#E50914] hover:bg-[#c40710] text-white font-black px-5 py-3 rounded-2xl text-xs uppercase tracking-widest shadow-lg shadow-red-500/20"
          >
            <QrCode size={16} />
            Scan QR to Order
          </button>
